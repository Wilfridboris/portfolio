...
const Projects = () => {
  ...
  return (
    <section id="projects" className="bg-beige py-24">
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-2xl font-bold mb-3 text-primary-dark group-hover:text-accent-orange transition-colors">
                  {project.title}
                </h3>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  <span className="text-accent-orange font-semibold group-hover:underline">
                    View Details →
                  </span>
